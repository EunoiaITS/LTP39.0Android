...
public class VipRegistrationActivity extends AppCompatActivity {
    ...
    public void onRegistrationClick() {
        ...
        int typeName = typeSpinner.getSelectedItemPosition();
        String typeId = singleID[typeName];

        progress.setTitle("Please wait.......");
        progress.show();
        RegisterVIP(vipName, vregNum, phn, purp, typeId);
    }
    ...
    public void RegisterVIP(String name, String car_reg, String phone, final String purpose, String vTy) {
        ...
        VIPRequest newRequest = new VIPRequest(name, vTy, client_id, car_reg, phone, purpose, emp_id, get_token);
        ...
        call.enqueue(new Callback<VIPRequestResponse>() {
            ...
            public void onResponse(Call<VIPRequestResponse> call, Response<VIPRequestResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    progress.hide();
                    Toast.makeText(VipRegistrationActivity.this, "Please fill in all the data!!", Toast.LENGTH_SHORT).show();
                }
            }
